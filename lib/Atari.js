...
const Atari = function() {
    ...
    /**
     * Start the session, so the player can start playing.
     * 1 - Request party start, if not started yet
     * 2 - Request player attempt
     */
    function start()
    {
        alert('vai startar - enviar request para node, de lá retornar o resultado da requisicao');
    }
