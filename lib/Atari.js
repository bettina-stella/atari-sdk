...
const Atari = function() {
    ...
    this.destroy = function () {
        ...
        if (user_gesture_check_interval) {
    ...
    let user_gesture_check_interval;
    ...
    function construct()
    {
        this.audio.config
            ...
            .watch('enabled', (data) => {
                this.socket.channel.emit('audio toggle', data.new.enabled, {
                    reliable: true,
                    interval: 50,
                    runs: 10,
                });
    ...
    function bindAudioEvents() {
         ...
         */
        user_gesture_check_interval = window.setInterval(() => {
    ...
    function reset()
    {
        this.socket.channel.emit('request reset', null, {
            reliable: true,
            interval: 50,
            runs: 30,
        });
